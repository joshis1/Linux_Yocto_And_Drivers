 ...
 *
 * Common configuration options for all Zinc boards.
 */

#ifndef __CONFIG_ZINC_COMMON_H
#define __CONFIG_ZINC_COMMON_H
...
#define ZINC_SCUTIMER_BASEADDR		0xF8F00600
#define CONFIG_SYS_TIMERBASE		ZINC_SCUTIMER_BASEADDR
...
#define CONFIG_SYS_LDSCRIPT  "arch/arm/mach-zinc/u-boot.lds"
